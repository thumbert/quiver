...
class InheritedWidgetExample extends StatefulWidget {
  ...
  static InheritedWidgetExampleState of(BuildContext context) {
    return context.findAncestorStateOfType<InheritedWidgetExampleState>()!;
  }
...
class MyStorePageState extends State<MyStorePage> {
  ...
  void _toggleSearch(BuildContext context) {
    ...
    InheritedWidgetExample.of(context).setProductList(Server.getProductList());
    _controller.clear();
  }
  ...
  void _handleSearch(BuildContext context) {
    ...
    InheritedWidgetExample.of(context)
...
class ProductListWidget extends StatelessWidget {
  ...
  void _handleRemoveFromCart(String id, BuildContext context) {
    InheritedWidgetExample.of(context).removeFromCart(id);
  }
