          ...
          Row(
            children: [
              Container(
                ...
                child: const Tooltip(
                  message:
                      'A number from 1 to 31, or a range e.g. 5-10,15,20-23',
                  child: Text(
                    'Days of month',
                  ),
                ),
  ...
  void validateDaysOfWeek() {
    setState(() {
      ...
      try {
        ...
        _errorDaysOfWeek = 'Day of week must be between 1 (Mon) and 7 (Sun)';
      }
    });
  }
