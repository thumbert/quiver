...
Future<void> tests(String rootUrl) async {
  group('Polygraph Tab tests', () {
    ...
    test('get valid tab name', () {
      ...
      expect(
          poly.getValidTabName(tabIndex: 0, suggestedName: 'Tab 1'), 'Tab 1');
      // 'Tab 2' is a valid name for tab index 0
      expect(
          poly.getValidTabName(tabIndex: 0, suggestedName: 'Tab 2'), 'Tab 2');
      ...
      expect(
          poly.getValidTabName(tabIndex: 0, suggestedName: 'Tab 1'), 'Tab 2');
      ...
      expect(
          poly.getValidTabName(tabIndex: 1, suggestedName: 'Tab 1'), 'Tab 2');
      ...
      var poly = PolygraphState(tabs: [
        PolygraphTab(
          ...
          windows: [
            PolygraphWindow(
              term: Term.parse(
                  'Jan21-Dec21', Iso.newEngland.preferredTimeZoneLocation),
              xVariable: TimeVariable(),
              yVariables: [
                VariableLmp(
                    iso: Iso.newEngland,
